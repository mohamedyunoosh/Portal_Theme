...
(function () {
	...
	function buildSidebarCSS(s) {
		...
		// === Search ===
		const sBg = v(s.search_bg_color, "#191f35");
		...
		const sHoverBoxShadow = v(s.search_hover_box_shadow, "0 4px 15px rgba(0, 0, 0, 0.4)");
		...
		// === Active ===
		const aBg = v(s.active_bg_color, "#080e24");
		const aTxt = v(s.active_text_color, "#fff");
		const aIcon = v(s.active_icon_color, "#fff");
		const aFW = v(s.active_font_weight, "600");
		const aRad = v(s.active_border_radius, 8);
		const aLCol = s.active_left_border_color || "#4463F0";
		const aLW = v(s.active_left_border_width, 2);

		// === Hover ===
		const hBg = v(s.hover_bg_color, "#101e4b");
		const hTxt = v(s.hover_text_color, "#9ba1b9");
		const hIcon = v(s.hover_icon_color, "#9ba1b9");
		...
		return `
/* ================================================ */
/* Portal Sidebar Theme — Auto-Generated CSS        */
/* ================================================ */
...
/* SEARCH BAR STYLING (from Item Theme) */
...
.body-sidebar [class*="search"] input:hover {
        box-shadow: ${sHoverBoxShadow} !important;
}
...
.standard-sidebar-item > .item-anchor.active {
        ...
        border-left: ${aLW}px solid ${aLCol} !important;
}
...
.standard-sidebar-item > .item-anchor:hover {
        ...
        transition: all ${hTr} ease-in-out !important;
}
